    ...
    public function __construct() 
    {
        ...
        { 
	        try
            {
                ...
                //self::$PDOInstance = new PDO('mysql:host=localhost;dbname=mccoyqrdb', 'mccoyuser', 'Temp1234');
                $file = 'config.ini';
                ...
                self::$PDOInstance = new PDO($dns, $settings['database']['username'], $settings['database']['password']);
